...
9. 같은 어미를 연속해서 사용하지 않는다.

10. AI가 정리한 정보성 글처럼 만들지 않는다.

11. 광고 문구처럼 과장하지 않는다.

12. SEO 키워드를 억지로 반복하지 않는다.

13. 제목과 소제목은 검색 의도를 고려하되
사람이 실제로 클릭할 만한 자연스러운 표현을 사용한다.

14. 네이버 블로그에서 실제 여행자가 작성한 후기처럼
읽히는 것이 최우선이다.

15. 최종 글에는
'AI가 작성했다는 느낌'이 들지 않도록 한다.
...
바로 복사해서 네이버 블로그에 붙여넣을 수 있는
완성된 본문을 작성한다.

불필요한 설명이나
'작성 이유', 'SEO 분석', '추천 이유' 등은 출력하지 않는다.
"""
